...
<h3 class="no-padding text-center-480 useradmin"><a href="#"><img class="userImg" src="public/images/user.jpg" alt="user"> <span class="username"></span>  </a> </h3>
</div>
...
<h3 class="page-sub-header2 clearfix no-padding">Hello <span class="username"></span> </h3>
<span class="page-sub-header-sub small">You last logged in at: <span id="lastLogin"></span> </span> </div>
...
<div class="col-sm-9">
<input type="text" class="form-control" placeholder="Update Address" id="address">
</div>
</div>
<div class="form-group">
...
<button type="submit" class="btn btn-primary" id="updateUserProfile">Update</button>
</div>
</div>
</form>
</div>
...
I want to receive advice on buying and selling. </label>
 ...
 <?php
 include 'calls/getUserProfile.php';
 ?>