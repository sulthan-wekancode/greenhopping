...
<h1 class="intro-title animated fadeInDown"> Green Hopping</h1>
<p class="sub animateme fittext3 animated fadeIn"> Find green juice bars & plant-based food </p>
...
<a href="category.html"><img src="http://nebula.wsimg.com/b99fcc6820dc5dff8ccacba56a2a6d3f?AccessKeyId=A0D87068EF9993E4FBE3&disposition=0&alloworigin=1" class="img-responsive" alt="img"> <h6> Organic Pressed </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/laptop-2.jpg" class="img-responsive" alt="img"> <h6> Laptops </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/mobile.jpg" class="img-responsive" alt="img"> <h6> Mobiles </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/tv.jpg" class="img-responsive" alt="img"> <h6> Electronics </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/hdd.jpg" class="img-responsive" alt="img"> <h6> Computer Accessories </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/house.jpg" class="img-responsive" alt="img"> <h6> Real Estate </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/Home-Electronics-Appliances-2.jpg" class="img-responsive" alt="img"> <h6> Home Appliances </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/camera.jpg" class="img-responsive" alt="img"> <h6> Cameras </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/fashion.jpg" class="img-responsive" alt="img"> <h6> Fashion & Beauty </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/toy.jpg" class="img-responsive" alt="img"> <h6> Kids & Baby Products </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/jobs.jpg" class="img-responsive" alt="img"> <h6> Jobs </h6> </a>
</div>
<div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
<a href="category.html"><img src="public/images/category/catalog.jpg" class="img-responsive" alt="img"> <h6> Home & Furniture </h6> </a>
</div>
</div>
</div>
...
<img class="img-responsive" src="public/images/item/tp/Image00011.jpg" alt="img">
</span>
...
<span class="item-carousel-thumb"> <img class="item-img" src="public/images/item/tp/Image00006.jpg" alt="img"> </span>
<span class="item-name"> consectetuer adipiscing elit </span>
<span class="price"> $ 240 </span></a> </div>
<div class="item"><a href="ads-details.html">
<span class="item-carousel-thumb"> <img class="item-img" src="public/images/item/tp/Image00022.jpg" alt="img"> </span> <span class="item-name"> sed diam nonummy </span> <span class="price"> $ 140</span></a></div>
<div class="item"><a href="ads-details.html">
<span class="item-carousel-thumb"> <img class="item-img" src="public/images/item/tp/Image00013.jpg" alt="img"> </span><span class="item-name"> feugiat nulla facilisis </span> <span class="price"> $ 140 </span></a></div>
<div class="item"><a href="ads-details.html">
<span class="item-carousel-thumb"> <img class="item-img" src="public/images/item/3.jpg" alt="img"> </span> <span class="item-name"> praesent luptatum zzril </span> <span class="price"> $ 220 </span></a></div>
<div class="item"><a href="ads-details.html">
<span class="item-carousel-thumb"> <img class="item-img" src="public/images/item/4.jpg" alt="img"> </span> <span class="item-name"> delenit augue duis dolore </span> <span class="price"> $ 120 </span></a></div>
<div class="item"><a href="ads-details.html">
<span class="item-carousel-thumb"> <img class="item-img" src="public/images/item/6.jpg" alt="img"> </span> <span class="item-name"> te feugait nulla facilisi </span> <span class="price"> $ 251 </span></a></div>
</div>
</div>
</div>
</div>
...
<li role="presentation"><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab"><i class="icon-search"></i> Top Search</a></li>
...
<div class="row"> <ul class="cat-list col-sm-3  col-xs-6 col-xxs-12">
...
<a class="dummy-aff-img" href="category.html"><img src="public/images/aff2.jpg" class="img-responsive" alt=" aff"> </a>
</div>
</div>
<div class="col-sm-3 page-sidebar col-thin-left">
<aside>
<div class="inner-box no-padding">
<div class="inner-box-content"> <a href="#"><img class="img-responsive" src="public/images/site/app.jpg" alt="tv"></a> </div>
</div>
<div class="inner-box">
...
<div class="inner-box no-padding"> <img class="img-responsive" src="public/images/add2.jpg" alt=""> </div>
</aside>
</div>
</div>
</div>
...
<div class="page-info" style="background: url(public/images/bg.jpg); background-size:cover">
