...
<h2 class="title-2"> <i class="icon-user-add"></i> Reset Password Success !</h2>
<div class="row">
<div class="col-sm-12">
...
<h2 class="no-margin no-padding">&#10004; Congratulations! You will receive a mail shortly to Reset your Password.</h2>
<p>Please write to admin@greenhopping.com if you don't receive any notification.</p>
</div>
